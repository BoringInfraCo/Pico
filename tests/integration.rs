...
#[path = "integration/sprint031_cli_test.rs"]
mod sprint031_cli_test;

#[path = "integration/sprint032_cli_test.rs"]
mod sprint032_cli_test;

#[path = "integration/sprint037_cli_test.rs"]
mod sprint037_cli_test;

#[path = "integration/sprint038_cli_test.rs"]
mod sprint038_cli_test;

#[path = "integration/sprint039_cli_test.rs"]
mod sprint039_cli_test;

#[path = "integration/sprint040_cli_test.rs"]
mod sprint040_cli_test;

#[path = "integration/sprint041_cli_test.rs"]
mod sprint041_cli_test;

#[path = "integration/sprint043_cli_test.rs"]
mod sprint043_cli_test;

#[path = "integration/sprint042_mcp_test.rs"]
mod sprint042_mcp_test;
