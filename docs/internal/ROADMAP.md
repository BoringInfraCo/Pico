...
uncertain) via a family fingerprint. This is not v0.4 complete. Authoritative slice scope:
...
v0.4  Security memory              IN PROGRESS (S024–S027; S028 finding lifecycle)
```
