...
cannot masquerade as ordinary lifecycle or environment changes. Proposed
Sprint 030 adds local retention, pruning, and database-health controls that
delete whole coherent scan units beyond a bounded window and never
fabricate disappearance. This is not v0.4 complete.
...
`docs/internal/sprints/SPRINT-029.md`. Proposed scope awaiting approval:
...
v0.4  Security memory              IN PROGRESS (S024–S029 DONE; S030 PROPOSED)
```
